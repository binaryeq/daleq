...
public class InstructionFactFactory__SIPUSH implements io.github.bineq.daleq.edb.InstructionPredicateFactFactory<org.objectweb.asm.tree.IntInsnNode> {
    ...
    @Override public io.github.bineq.daleq.edb.InstructionPredicate getPredicate() {
        return io.github.bineq.daleq.edb.PredicateRegistry.INSTRUCTION_PREDICATES.get(17);
    }
    ...
    @Override public Fact createFact(String factId,org.objectweb.asm.tree.IntInsnNode node,String methodRef,int instructionCounter,Map<LabelNode,Integer> labelMap) {
        return new io.github.bineq.daleq.edb.SimpleFact(io.github.bineq.daleq.edb.PredicateRegistry.INSTRUCTION_PREDICATES.get(17),new Object[]{factId,methodRef,instructionCounter,node.operand});
    }
