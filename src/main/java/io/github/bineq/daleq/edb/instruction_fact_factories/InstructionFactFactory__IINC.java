...
public class InstructionFactFactory__IINC implements io.github.bineq.daleq.edb.InstructionPredicateFactFactory<org.objectweb.asm.tree.IincInsnNode> {
    ...
    @Override public io.github.bineq.daleq.edb.InstructionPredicate getPredicate() {
        return io.github.bineq.daleq.edb.PredicateRegistry.INSTRUCTION_PREDICATES.get(132);
    }
    ...
    @Override public Fact createFact(String factId,org.objectweb.asm.tree.IincInsnNode node,String methodRef,int instructionCounter,Map<LabelNode,Integer> labelMap) {
        return new io.github.bineq.daleq.edb.SimpleFact(io.github.bineq.daleq.edb.PredicateRegistry.INSTRUCTION_PREDICATES.get(132),new Object[]{factId,methodRef,instructionCounter,node.incr,node.var});
    }
