...
public class InstructionFactFactory__PUTFIELD implements io.github.bineq.daleq.factextraction.InstructionPredicateFactFactory<org.objectweb.asm.tree.FieldInsnNode> {
    ...
    @Override public Fact createFact(org.objectweb.asm.tree.FieldInsnNode node,String methodRef,int instructionCounter) {
        return new io.github.bineq.daleq.factextraction.SimpleFact(io.github.bineq.daleq.factextraction.FactExtractor.REGISTRY.get(181),new Object[]{methodRef,instructionCounter,node.owner,node.name,node.desc});
    }
