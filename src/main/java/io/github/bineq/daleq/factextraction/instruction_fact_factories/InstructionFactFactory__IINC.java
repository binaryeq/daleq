...
public class InstructionFactFactory__IINC implements io.github.bineq.daleq.factextraction.InstructionPredicateFactFactory<org.objectweb.asm.tree.IincInsnNode> {
    ...
    @Override public String createFact(org.objectweb.asm.tree.IincInsnNode node,String methodRef,int instructionCounter) {
        return methodRef + '\t' + String.valueOf(instructionCounter) + '\t' + String.valueOf(node.incr) + '\t' + String.valueOf(node.var);
    }
