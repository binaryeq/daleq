...
public class InstructionFactFactory__LOOKUPSWITCH implements io.github.bineq.daleq.factextraction.InstructionPredicateFactFactory<org.objectweb.asm.tree.LookupSwitchInsnNode> {
    ...
    @Override public Fact createFact(org.objectweb.asm.tree.LookupSwitchInsnNode node,String methodRef,int instructionCounter,Map<LabelNode,Integer> labelMap) {
        return new io.github.bineq.daleq.factextraction.SimpleFact(io.github.bineq.daleq.factextraction.FactExtractor.REGISTRY.get(171),new Object[]{methodRef,instructionCounter,labelMap.get(node.dflt),node.keys,node.labels});
    }
